...
class DataSet:
    ...
    def vb_value(self):
        ...
        data = np.delete(vb_data, 94)#因为第94组数据的采集样本具有异常，需要剔除
        return data
    @property
    ...
    def export_as_pd(self):
        ...
        catalog = ['time','DOC','feed','material','VB']
        data_dict = {}
        for i in catalog:
...
if __name__ == '__main__':
    ...
    print('material_type:',material_list.shape)

    conf_number = a.number_value
    print('number_value:',conf_number.shape)
